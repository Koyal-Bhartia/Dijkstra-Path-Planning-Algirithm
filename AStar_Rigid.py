...
def createMap():
    ...
    for x in range(0,image_width):
        for y in range(0,image_height):
            ...
            if ExtendCircle-math.pow(ExtendCirRad,2)<=0:
                white_image[image_height-1-y,x]=[0,0,255]
...
if __name__ == '__main__':
    ...
    while(flag!=1):
        ...
        try:
            ...
            if Clearance>=0:
                ...
                print("Please enter a postive value for clearance")
        except ValueError:
    ...
    TotClear=int(np.round((radius+Clearance)*resolution,1))
    fourteen=14*resolution
    createMap()
    print("Map created")
