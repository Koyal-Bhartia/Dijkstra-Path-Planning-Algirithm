...
def createMap():
    ...
    for x in range(0,image_width):
        for y in range(0,image_height):
            ...
            if CircleObstacle-math.pow(CircleRad,2)<=0:
                white_image[image_height-1-y,x]=[0,0,0]
...
def Heuristic(parentx,parenty):
    dist=np.sqrt(math.pow(parentx-goalx,2)+math.pow(parenty-goaly,2))
    #dist=np.abs(parentx-goalx)+np.abs(parenty-goaly)
    #dist=np.abs(parentx-goalx)+np.sqrt(2)*np.abs(parenty-goaly)
    return dist
    ...
    while(allNodesInfo[image_width*goalx+goaly,5]!=50000):
        ...
        if UpX>-1 and (white_image[UpX,UpY][0]+white_image[UpX,UpY][1]+white_image[UpX,UpY][2])!=0:
                ...
                if newupcost<allNodesInfo[image_width*UpX+UpY,2]:
                    ...
                    allNodesInfo[image_width*UpX+UpY,5]=newupcost+Heuristic(UpX,UpY)
                    allNodesInfo[image_width*UpX+UpY,3]=parentx
                    allNodesInfo[image_width*UpX+UpY,4]=parenty
                    white_image[UpX,UpY]=[102,0,51]

        if DownX<image_height and (white_image[DownX,DownY][0]+white_image[DownX,DownY][1]+white_image[DownX,DownY][2])!=0:
                ...
                if newdowncost<allNodesInfo[image_width*DownX+DownY,2]:
                    ...
                    allNodesInfo[image_width*DownX+DownY,5]=newdowncost+Heuristic(DownX,DownY)
        ...
        if LeftY>-1 and (white_image[LeftX,LeftY][0]+white_image[LeftX,LeftY][1]+white_image[LeftX,LeftY][2])!=0 :
                ...
                if newleftcost<allNodesInfo[image_width*LeftX+LeftY,2]:
                    ...
                    allNodesInfo[image_width*LeftX+LeftY,5]=newleftcost+Heuristic(LeftX,LeftY)
        ...
        if RightY<image_width and (white_image[RightX,RightY][0]+white_image[RightX,RightY][1]+white_image[RightX,RightY][2])!=0:
                ...
                if newrightcost<allNodesInfo[image_width*RightX+RightY,2]:
                    ...
                    allNodesInfo[image_width*RightX+RightY,5]=newrightcost+Heuristic(RightX,RightY)
        ...
        if UpLeftX>-1 and UpLeftY>-1 and RightY<image_width and (white_image[UpLeftX,UpLeftY][0]+white_image[UpLeftX,UpLeftY][1]+white_image[UpLeftX,UpLeftY][2])!=0 :
                ...
                if newupleftcost<allNodesInfo[image_width*UpLeftX+UpLeftY,2]:
                    ...
                    allNodesInfo[image_width*UpLeftX+UpLeftY,5]=newupleftcost+Heuristic(UpLeftX,UpLeftY)
        ...
        if UpRightX>-1 and UpRightY<image_width and (white_image[UpRightX,UpRightY][0]+white_image[UpRightX,UpRightY][1]+white_image[UpRightX,UpRightY][2])!=0:
                ...
                if newuprightcost<allNodesInfo[image_width*UpRightX+UpRightY,2]:
                    ...
                    allNodesInfo[image_width*UpRightX+UpRightY,5]=newuprightcost+Heuristic(UpRightX,UpRightY)
        ...
        if DownLeftY>-1 and DownLeftX<image_height and (white_image[DownLeftX,DownLeftY][0]+white_image[DownLeftX,DownLeftY][1]+white_image[DownLeftX,DownLeftY][2])!=0:
                ...
                if newdownleftcost<allNodesInfo[image_width*DownLeftX+DownLeftY,2]:
                    ...
                    allNodesInfo[image_width*DownLeftX+DownLeftY,5]=newdownleftcost+Heuristic(DownLeftX,DownLeftY)
        ...
        if DownRightY<image_width and DownLeftX<image_height and (white_image[DownRightX,DownRightY][0]+white_image[DownRightX,DownRightY][1]+white_image[DownRightX,DownRightY][2])!=0:
                ...
                if newdownrightcost<allNodesInfo[image_width*DownRightX+DownRightY,2]:
                    ...
                    allNodesInfo[image_width*DownRightX+DownRightY,5]=newdownrightcost+Heuristic(DownRightX,DownRightY)
...
def video(img_array):
    video=cv2.VideoWriter('A.avi',cv2.VideoWriter_fourcc(*'DIVX'), 38,(image_width,image_height))
...
if __name__ == '__main__':
    ...
    while(flag!=1):
        ...
        try:
            ...
            if(goalx in range(0,height_check) and goaly in range(0,width_check)):
    ...
    print("Exploration done, Creating Video")
    video(img_array)
    print("Video created, please check folder")
